import { Car, Leaf, Mail, MapPin } from "lucide-react";
    ...
    <footer id="about" className="bg-muted/30 border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-lg font-bold">Loop<span className="text-primary">+</span></h3>
                <p className="text-xs text-muted-foreground leading-none">by Renault</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground">
              Trusted shared mobility inside real communities. Commute better, together.
            </p>
            <div className="flex items-center gap-2 text-sm text-secondary">
              <Leaf className="w-4 h-4" />
              <span className="font-medium">45T CO₂ saved this year</span>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© 2025 Renault Loop+. All rights reserved.</p>
